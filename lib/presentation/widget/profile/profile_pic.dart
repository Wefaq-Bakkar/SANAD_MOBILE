  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          const CircleAvatar(
            backgroundImage: NetworkImage("https://i.postimg.cc/jwPcd3Yd/eps10-grey-user-icon-or-logo-in-simple-flat-trendy-modern-style-isolated-on-white-background-free-ve.jpg"),
          ),
          Positioned(
            right: -16,
            bottom: 0,
